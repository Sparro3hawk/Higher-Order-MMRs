...
def setup_radius_dataset(planet_count_min = 3, planet_count_max = 7):
    ...
    pl_rade_shape, pl_rade_loc, pl_rade_scale = lognorm.fit(radius_ratios) # the outputs had previously been in the wrong order, but I put them into lognorm.rvs in the same wrong order, so the end result was correct.
